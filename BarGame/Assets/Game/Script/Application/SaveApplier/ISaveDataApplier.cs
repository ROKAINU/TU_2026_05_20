...
namespace Game.Application
{
    public interface ISaveDataApplier
    {
        ...
        Task ApplyGameDataToStoresAsync(GameSaveData saveData);

        /// <summary>
        /// 設定のセーブデータをストアに適用する。セーブデータの内容に基づいて、ストアの状態を更新する。
        /// </summary>
        /// <param name="saveData">適用する設定のセーブデータ</param>
        Task ApplySettingsDataToStoresAsync(SettingSaveData saveData);
        ...
        Task ApplyAllDataToStoresAsync(GameSaveData saveData, SettingSaveData settingData);
    }
}