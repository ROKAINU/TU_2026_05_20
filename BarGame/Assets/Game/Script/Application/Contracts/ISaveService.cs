...
namespace Game.Application.Contracts
{
    public interface ISaveService
    {
        ...
        Task SaveGameDataAsync(GameSaveData saveData, CancellationToken ct = default);
        ...
        /// <param name="ct">キャンセル トークン</param>
        Task SaveSettingsDataAsync(SettingSaveData saveData, CancellationToken ct = default);
        ...
        Task<GameSaveData> LoadGameDataAsync(CancellationToken ct = default);
        ...
        Task<SettingSaveData> LoadSettingsDataAsync(CancellationToken ct = default);
